...
public class CelebrationsEngine {
    ...
    private void rebuildDatabase() {
        ...
        try {
            AssetManager ttttt = context.getAssets();
            String[] ggggg = ttttt.list("");
            ...
            // Moving Special
            ArrayList<String> ggggg1 = new ArrayList<>();
            ggggg1.add("ΧΛΟΗ");
            ...
            // Moving Special
            ArrayList<String> ggggg2 = new ArrayList<>(
            ...
            // Moving Special
            ArrayList<String> ggggg3 = new ArrayList<>(
            ...
            // Moving Special
            ArrayList<String> ggggg4 = new ArrayList<>(
    ...
    public static class CelebrationsDatabase {
        public HashMap<CelebrationDate, ArrayList<String>> all = new HashMap<>();
        public HashMap<CelebrationDate, ArrayList<String>> off = new HashMap<>();
    }
